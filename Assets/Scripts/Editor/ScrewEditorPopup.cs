...
public class ScrewEditorPopup : EditorWindow
{
	...
	private int MaxNuts = 6;

	public static void Open(Screw screw, Nut nutPrefab,Transform parent)
	{
	...
	private void OnGUI()
	{
		...
		if (newCount != currentCount)
		{
			...
			if (newCount > currentCount)
			{
				...
				{
					Nut newNut = (Nut)PrefabUtility.InstantiatePrefab(nutPrefab, parent);
					newNut.transform.SetParent(screw.transform, true);
